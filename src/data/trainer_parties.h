...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .moves = {MOVE_ROCK_SLIDE, MOVE_SLAM, MOVE_IRON_TAIL, MOVE_SANDSTORM}
    },
    {
    .iv = 255,
    .lvl = 14,
    ...
    .moves = {MOVE_REST, MOVE_TOXIC, MOVE_DIG, MOVE_PROTECT}
    },
    {
    .iv = 255,
    .lvl = 14,
    ...
    .moves = {MOVE_MEGA_PUNCH, MOVE_MAGNITUDE, MOVE_DEFENSE_CURL, MOVE_ROCK_TOMB}
    },
    {
    .iv = 255,
    .lvl = 15,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_THUNDER_WAVE, MOVE_MAGNITUDE, MOVE_SHOCK_WAVE, MOVE_ROCK_TOMB}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly1[] = {
    ...
    .species = SPECIES_MACHOP,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_KARATE_CHOP, MOVE_ROCK_SLIDE, MOVE_FOCUS_ENERGY, MOVE_BULK_UP}
    },
    {
    .iv = 255,
    .lvl = 18,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_DOUBLE_KICK, MOVE_AERIAL_ACE, MOVE_EMBER, MOVE_BULK_UP}
    },
    {
    .iv = 255,
    .lvl = 18,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_BRICK_BREAK, MOVE_ROCK_TOMB, MOVE_BULK_UP, MOVE_DIG}
    },
    {
    .iv = 255,
    .lvl = 19,
    .species = SPECIES_BRELOOM,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_MEGA_DRAIN, MOVE_SKY_UPPERCUT, MOVE_STUN_SPORE, MOVE_MACH_PUNCH}
    }
};
