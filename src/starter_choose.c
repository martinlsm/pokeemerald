...
// TODO: Fix only useless moves at lvl 5
static const u16 sStarterMon[NUMBER_OF_MON_TYPES][STARTER_MON_COUNT] =
{
    [TYPE_NORMAL] = {SPECIES_DODUO, SPECIES_TEDDIURSA, SPECIES_PIDGEY},
    [TYPE_FIGHTING] = {SPECIES_MACHOP, SPECIES_MANKEY, SPECIES_MAKUHITA},
    [TYPE_FLYING] = {SPECIES_SPEAROW, SPECIES_NATU, SPECIES_DODUO},
    [TYPE_POISON] = {SPECIES_BULBASAUR, SPECIES_TENTACOOL, SPECIES_ZUBAT},
    [TYPE_GROUND] = {SPECIES_CUBONE, SPECIES_PHANPY, SPECIES_SANDSHREW},
    [TYPE_ROCK] = {SPECIES_GEODUDE, SPECIES_LARVITAR, SPECIES_ARON},
    [TYPE_BUG] = {SPECIES_ANORITH, SPECIES_CATERPIE, SPECIES_YANMA},
    [TYPE_GHOST] = {SPECIES_GASTLY, SPECIES_SABLEYE, SPECIES_MISDREAVUS},
    [TYPE_STEEL] = {SPECIES_MAGNEMITE, SPECIES_ARON, SPECIES_SKARMORY},
    [TYPE_FIRE] = {SPECIES_CYNDAQUIL, SPECIES_MAGBY, SPECIES_HOUNDOUR},
    [TYPE_WATER] = {SPECIES_CHINCHOU, SPECIES_CORPHISH, SPECIES_STARYU},
    [TYPE_GRASS] = {SPECIES_EXEGGCUTE, SPECIES_ODDISH, SPECIES_CACNEA},
    [TYPE_ELECTRIC] = {SPECIES_VOLTORB, SPECIES_ELEKID, SPECIES_CHINCHOU},
    [TYPE_PSYCHIC] = {SPECIES_ABRA, SPECIES_EXEGGCUTE, SPECIES_NATU},
    [TYPE_ICE] = {SPECIES_SPHEAL, SPECIES_SNEASEL, SPECIES_SMOOCHUM},
    [TYPE_DRAGON] = {SPECIES_DRATINI, SPECIES_BAGON, SPECIES_TRAPINCH},
    [TYPE_DARK] = {SPECIES_CARVANHA, SPECIES_MURKROW, SPECIES_HOUNDOUR},
};
...
u16 GetStarterPokemon(u16 chosenStarterId)
{
    ...
    return sStarterMon[gSaveBlock2Ptr->nuzlockeType][chosenStarterId];
}
